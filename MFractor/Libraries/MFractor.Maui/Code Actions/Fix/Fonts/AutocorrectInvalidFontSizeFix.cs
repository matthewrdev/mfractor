...
{
    class AutocorrectInvalidFontSizeFix : FixCodeAction
	{
        public override string Documentation => "When a developer accidentally mispells a named FontSize value, this fix will auto-correct it to a valid font size name.";

        public override Type TargetCodeAnalyser => typeof(InvalidNamedFontSizeAnalysis);

        public override string Identifier => "com.mfractor.code_fixes.xaml.autocorrect_invalid_font_size";

        public override string Name => "Autocorrect Invalid FontSize";
