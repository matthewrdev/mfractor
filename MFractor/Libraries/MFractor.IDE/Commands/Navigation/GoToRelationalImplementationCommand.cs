...
namespace MFractor.Ide.Commands.Navigation
{
    ...
    [Export]
    class GoToRelationalImplementationCommand : ICommand
    {
        ...
        public GoToRelationalImplementationCommand(Lazy<IWorkEngine> workEngine,
        ...
        public void Execute(ICommandContext commandContext)
        {
            ...
            var result = resolver.NavigateToImplementation(projectFile.CompilationProject, projectFile.FilePath, configId);
        ...
        public ICommandState GetExecutionState(ICommandContext commandContext)
        {
            ...
            var canNavigate = handler.CanNavigateToImplementation(projectFile.CompilationProject, projectFile.FilePath, configId);
            if (!canNavigate)
            {
                return CommandState.BlockOthers;
            }
            ...
            return new CommandState()
            {
                ...
                Label = $"Go To {handler.ImplementationDisplayName}",
                Description = $"Navigates to the {handler.ImplementationDisplayName} for this file"
            };
        }
    }
}