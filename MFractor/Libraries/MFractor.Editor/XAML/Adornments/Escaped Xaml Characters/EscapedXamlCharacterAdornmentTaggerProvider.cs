...
namespace MFractor.Editor.XAML.Adornments.EscapedXamlCharacters
{
    ...
    class EscapedXamlCharacterAdornmentTaggerProvider : IViewTaggerProvider
    {
        ...
        internal EscapedXamlCharacterAdornmentTaggerProvider(Lazy<ILicensingService> licensingService,
        ...
        public ITagger<T> CreateTagger<T>(ITextView textView, ITextBuffer buffer) where T : ITag
        {
            ...
            return EscapedXamlCharacterAdornmentTagger.GetTagger(
                (IWpfTextView)textView,
                new Lazy<ITagAggregator<EscapedCharacterTag>>(
                    () => BufferTagAggregatorFactoryService.CreateTagAggregator<EscapedCharacterTag>(textView.TextBuffer)))
                as ITagger<T>;
        }
    }
}
