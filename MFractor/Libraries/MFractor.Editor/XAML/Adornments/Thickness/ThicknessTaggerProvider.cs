...
namespace MFractor.Editor.XAML.Adornments.Thickness
{
    ...
    [TagType(typeof(ThicknessTag))]
    sealed class ThicknessTaggerProvider : ITaggerProvider
    {
        ...
        internal ThicknessTaggerProvider(Lazy<ITextDocumentFactoryService> textDocumentFactory,
        ...
        public ITagger<T> CreateTagger<T>(ITextBuffer buffer) where T : ITag
        {
            ...
            return buffer.Properties.GetOrCreateSingletonProperty(() => new ThicknessTagger(textDocument.FilePath, XmlSyntaxTreeService)) as ITagger<T>;
        }
    }
}